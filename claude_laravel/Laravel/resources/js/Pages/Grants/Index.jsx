    ...
    return (
        <>
            ...
            >
                ...
                {showSettings && (
                    <div className="fixed inset-0 z-[998] flex items-end md:items-center justify-center bg-[#0d2b2b]/40 backdrop-blur-md"
                        onClick={() => setShowSettings(false)}>
                        <div className="w-full max-w-4xl bg-white rounded-t-2xl md:rounded-2xl overflow-hidden shadow-2xl max-h-[90vh] overflow-y-auto"
                            onClick={e => e.stopPropagation()}>
                            <ConfigPageInline onClose={() => setShowSettings(false)} />
                        </div>
                    </div>
                )}
            </AppLayout>
