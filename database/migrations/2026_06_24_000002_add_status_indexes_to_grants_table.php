...
{
    /**
     * applied/ignore/reviewed are both filtered (status dropdown) and
     ...
     * on navigation. Unlike starred/offers_cash/area_relevant in the
     * original grants migration, they were never indexed.
     */
    public function up(): void
    {
        ...
        // previous run can leave some indexes already created while this
        // migration is still marked as not-yet-run. Guard each one via
